...
INSERT INTO `zhongyuan_archives` VALUES (1,2,'0',1402240384,'p',1,1,0,112,0,'银行优先股对老股东极其坑爹，达到恐怖级别','','','admin','未知','/uploads/allimg/145ad419d5fa93feffb1ca88.jpg!topic.png',1402240384,1402048499,1,'银行,优先股,对,老,股东,极其,坑爹,达到,恐怖,',0,0,0,0,0,0,'银行优先股对老股东极其坑爹，达到恐怖级别--以兴业银行为例 下表是兴业银行优先股转股模拟，假设兴业银行每年净资产增长15%，这点对持有兴业银行的小散们的最低要求了吧，因为','',1,0,0,0);
...
INSERT INTO `zhongyuan_member_tj` VALUES (1,0,0,0,0,11,0,0,0,0,0,0);
...
-- Dump completed on 2014-06-08 23:24:34
